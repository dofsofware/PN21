...
## Installation de java _(version 8)_

pour installer java ouvrez le terminal et tapez la commande ci-apres

    sudo apt install openjdk-8-jdk

Pour s'assurer que vous avez bien installé java tapez la commande ci-apres
