...
import com.secusociale.portail.repository.TestEntityRepository;
...
/**
 * REST controller for managing {@link com.secusociale.portail.domain.TestEntity}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TestEntityResource {
    ...
    private static final String ENTITY_NAME = "portailCssIpresV2TestEntity";
