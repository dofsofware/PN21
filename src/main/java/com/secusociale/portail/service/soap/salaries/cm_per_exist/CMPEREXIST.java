 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="perExist" minOccurs="0">
 *                     &lt;simpleType>
 *                       &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *                         &lt;maxLength value="4000"/>
 *                       &lt;/restriction>
...
@XmlRootElement(name = "CM_PER_EXIST")
public class CMPEREXIST {

    @XmlElement(namespace = "http://oracle.com/CM_PER_EXIST.xsd", defaultValue = "CM_PER_EXIST")
    protected String zone;
    @XmlElement(namespace = "http://oracle.com/CM_PER_EXIST.xsd")
    ...
    public static class Results {
        ...
        @XmlElement(namespace = "http://oracle.com/CM_PER_EXIST.xsd")
        protected String perExist;
        @XmlAttribute(name = "action")
        protected ListAction action;

        /**
         * Obtient la valeur de la propriété perExist.
         *
         * @return
         *     possible object is
         *     {@link String }
         *
         */
        public String getPerExist() {
            return perExist;
        }

        /**
         * Définit la valeur de la propriété perExist.
         *
         * @param value
         *     allowed object is
         *     {@link String }
         *
         */
        public void setPerExist(String value) {
            this.perExist = value;
        }
