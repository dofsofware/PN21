 ...
 */
public class JournalJobCriteria implements Serializable, Criteria {
    ...
    public JournalJobCriteria() {
    }


    public JournalJobCriteria(JournalJobCriteria other) {
    ...
    @Override
    public JournalJobCriteria copy() {
        return new JournalJobCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final JournalJobCriteria that = (JournalJobCriteria) o;
        return
