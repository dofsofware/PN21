...
public class AgencesRattachementService {
    ...
    private final Logger log = LoggerFactory.getLogger(AgencesRattachementService.class);

    public Holder<AGENCESEMPLOYEURSERVICE> getAgencesRattachement(String numeroUnique) throws Exception {
