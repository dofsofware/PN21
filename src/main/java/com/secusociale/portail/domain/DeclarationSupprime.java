...
@Entity
public class DeclarationSupprime implements Serializable {
    ...
    public DeclarationSupprime(Declaration declaration) {
    ...
    public DeclarationSupprime uuid(String uuid) {
        this.uuid = uuid;
        return this;
    }

    public DeclarationSupprime synthese(Long synthese) {
    ...
    public DeclarationSupprime typeIdentifiant(String typeIdentifiant) {
    ...
    public DeclarationSupprime idIdentifiant(String idIdentifiant) {
    ...
    public DeclarationSupprime typeDeclaration(String typeDeclaration) {
    ...
    public DeclarationSupprime debutCotisation(Instant debutCotisation) {
    ...
    public DeclarationSupprime finCotisation(Instant finCotisation) {
    ...
    public DeclarationSupprime address(String address) {
    ...
    public DeclarationSupprime processFlowId(String processFlowId) {
    ...
    public DeclarationSupprime raisonSociale(String raisonSociale) {
    ...
    public DeclarationSupprime createAt(Instant createAt) {
    ...
    public DeclarationSupprime isUploaded(Boolean isUploaded) {
    ...
    public DeclarationSupprime fileURL(String fileURL) {
    ...
    public DeclarationSupprime numeroUnique(String numeroUnique) {
    ...
    public DeclarationSupprime iPDIDTRAITEMENT(String iPDIDTRAITEMENT) {
    ...
    public DeclarationSupprime details(String details) {
    ...
    public DeclarationSupprime status(String status) {
        this.status = status;
        return this;
    }
    ...
    public DeclarationSupprime fileName(String fileName) {
    ...
    public DeclarationSupprime isRead(Boolean isRead) {
        this.isRead = isRead;
        return this;
    }
    ...
    public DeclarationSupprime ownerID(Long ownerID) {
        this.ownerID = ownerID;
        return this;
    }
    ...
    public DeclarationSupprime reponseBrute(String reponseBrute) {
    ...
    public DeclarationSupprime codeAgenceCSS(String codeAgenceCSS) {
    ...
    public DeclarationSupprime codeAgenceIPRES(String codeAgenceIPRES) {
    ...
    public DeclarationSupprime requeteBrute(String requeteBrute) {
    ...
    public DeclarationSupprime nombreErreurs(Long nombreErreurs) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeclarationSupprime)) {
            return false;
        }
        return id != null && id.equals(((DeclarationSupprime) o).id);
    }
